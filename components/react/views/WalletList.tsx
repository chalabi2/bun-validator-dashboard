  ...
  return (
    <div className="mt-2 text-center sm:mt-0.5 sm:text-left">
      <div className="flex flex-row items-center justify-between pl-3">
        ...
        <button
          type="button"
          className="p-2 text-black bg-gray-bg rounded-full hover:bg-gray-200 dark:text-white dark:bg-gray-lightbg dark:hover:bg-white/10"
          onClick={onClose}
        >
      ...
      <div className="flex flex-col w-full mt-2 space-y-2 mb-2">
        {wallets.map(({ walletInfo: { name, prettyName, logo } }) => (
          <button
            ...
            className="inline-flex items-center justify-between w-full px-2 py-2.5 transition duration-150 ease-in-out bg-gray-bg  border rounded-lg border-black/10 dark:border-white/10 dark:bg-gray-lightbg group hover:border-purple-200"
          >
            <div className="flex flex-row items-center space-x-2">
              ...
              />
              <p className="font-medium text-white dark:text-black group-hover:text-purple-damp">
                {prettyName}
              </p>
            </div>
